...
// Metodo Para Execuções
  ...
  TF_CaixaMovimento = class(TForm)
    ...
    N6: TMenuItem;
    ADOQCaixaMovim: TADOQuery;
    DSCaixaMovim: TDataSource;
    ...
    DBText1: TDBText;
    Label1: TLabel;
    ADOQCaixaMovimID: TAutoIncField;
    ADOQCaixaMovimID_CAIXAMOV: TIntegerField;
    ADOQCaixaMovimSTATUS: TStringField;
    ADOQCaixaMovimINATIVO: TStringField;
    ADOQCaixaMovimDATA_INC: TDateTimeField;
    ADOQCaixaMovimDATA_ALT: TDateTimeField;
    ADOQCaixaMovimDATA_HAB: TDateTimeField;
    ADOQCaixaMovimSERVICO: TStringField;
    ADOQCaixaMovimCLIENTE: TStringField;
    ADOQCaixaMovimHISTORICO: TStringField;
    ADOQCaixaMovimVLMOVIMENTO: TBCDField;
    ADOQCaixaMovimESPECIE: TStringField;
    ADOQCaixaMovimTIPO_MOVIMENTO: TStringField;
    ADOCaixa_AbreFecha: TADOQuery;
    ADOUsuarios: TADOQuery;
    DSCaixa_AbreFecha: TDataSource;
    ADOCaixa_AbreFechaID: TAutoIncField;
    ADOCaixa_AbreFechaDATA_INICIO: TDateTimeField;
    ADOCaixa_AbreFechaDATA_FINAL: TDateTimeField;
    ADOCaixa_AbreFechaHORA_INICIO: TWideStringField;
    ADOCaixa_AbreFechaHORA_FINAL: TWideStringField;
    ADOCaixa_AbreFechaUSER_INICIO: TIntegerField;
    ADOCaixa_AbreFechaUSER_FINAL: TIntegerField;
    ADOCaixa_AbreFechaVLTOTALRECEBIDO: TFloatField;
    ADOCaixa_AbreFechaVLTOTALSAIDA: TFloatField;
    ADOCaixa_AbreFechaVLTOTALGERAL: TFloatField;
    ADOCaixa_AbreFechaVLSAIDACONTAS: TFloatField;
    ADOCaixa_AbreFechaSALDO_DINHEIRO: TFloatField;
    ADOCaixa_AbreFechaSALDO_BOLETO: TFloatField;
    ADOCaixa_AbreFechaSALDO_CHEQUE: TFloatField;
    ADOCaixa_AbreFechaSALDO_CARTAO: TFloatField;
    ADOCaixa_AbreFechaSAIDA_DINHEIRO: TFloatField;
    ADOCaixa_AbreFechaSAIDA_CHEQUE: TFloatField;
    ADOUsuariosID: TAutoIncField;
    ADOUsuariosSTATUS: TStringField;
    ADOUsuariosINATIVO: TStringField;
    ADOUsuariosDATA_INC: TDateTimeField;
    ADOUsuariosDATA_ALT: TDateTimeField;
    ADOUsuariosDATA_HAB: TDateTimeField;
    ADOUsuariosDESC_USUARIO: TStringField;
    ADOUsuariosLOGIN: TStringField;
    ADOUsuariosSENHA: TStringField;
    ADOUsuariosID_PERFIL: TIntegerField;
    GroupBox5: TGroupBox;
    Label26: TLabel;
    Label28: TLabel;
    Label30: TLabel;
    ...
    DBEdit26: TDBEdit;
    DBEdit28: TDBEdit;
    ADOCaixa_AbreFechaUSERINICIO: TStringField;
    ADOCaixa_AbreFechaUSERFINAL: TStringField;
    DBGrid1: TDBGrid;
    ADOCaixa_AbreFechaVL_INICIO: TBCDField;
    ADOCaixa_AbreFechaVL_FECHAMENTO: TBCDField;
  ...
  public
    ...
    procedure SomaTudo;   // Somar Todas os Recebimentos
  end;

var
  F_CaixaMovimento: TF_CaixaMovimento;
...
procedure TF_CaixaMovimento.btnAlterarClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.btnAnteriorClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.btnFinalClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.btnGravarClick(Sender: TObject);
var
...
procedure TF_CaixaMovimento.btnIncluirClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.btnInicioClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.btnOkClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.btnProximoClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.btnReverterClick(Sender: TObject);
begin
  // Verificando o que esta sendo Feito -- Adicionando  ou Editando Para Dar a mensagem
    if ADOTabela.State in [dsInsert] then               //*********** ADOQUERY = ADOTABELS **************************************
        begin
...
procedure TF_CaixaMovimento.btnSairClick(Sender: TObject);
begin
  Close; // Fechar a Tela
end;


procedure TF_CaixaMovimento.Descrio1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
...
procedure TF_CaixaMovimento.edtValorCampoKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TF_CaixaMovimento.ExcluirUMRegClick(Sender: TObject);
...
procedure TF_CaixaMovimento.FormActivate(Sender: TObject);
begin
  ADOTabela:= ADOCaixa_AbreFecha;   // Definindo o Valor da Variavel que ira Receber o ADOQuery   //*********** ADOQUERY = ADOTABELS ******************
  nomeTabela:= 'TB_CAIXA_ABREFECHA'; // Definindo a Tabela para trabalhar
  nomeJanela:= 'Movimentacao do Caixa';  // Nome que ira aparecer
  GridLista.DataSource:= DSCaixa_AbreFecha;    //Colocando o Data Source no Grid
 // DescPrincipal:= 'DESC_USUARIO';  // Define o Campo que ira Fazer a Pesquisa Padrao por Desc.

    ModoEdicao:= F_Principal.ADOQLogin.FieldByName('CAIXAMOVIMENTACAO_INC').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('CAIXAMOVIMENTACAO_ALT').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('CAIXAMOVIMENTACAO_EXC').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('CAIXAMOVIMENTACAO_MAR').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('CAIXAMOVIMENTACAO_IMP').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('CAIXAMOVIMENTACAO_INA').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('CAIXAMOVIMENTACAO_HAB').AsAnsiString;

// Caption dos ApplicationMessageBox  Do EXECUTAR SentencaSQL
    MensageAppMesBox:= 'MOVIMENTACOES DO CAIXA';
...
ADOCaixa_AbreFecha.Open;
ADOUsuarios.Open;
ADOQCaixaMovim.Open;

// Colocando a aba de Entrada como padao
PageControl1.ActivePageIndex:= 0;

// PROCEDURE PARA SOMAR TUDO
SomaTudo;

end;

procedure TF_CaixaMovimento.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
// FECHABDO OS COMPONENTES
ADOCaixa_AbreFecha.Close;
ADOUsuarios.Close;
ADOQCaixaMovim.Close;
end;

procedure TF_CaixaMovimento.GridListaDblClick(Sender: TObject);
begin
       // ADOTabela.Locate('ID',ADOTabelaID.Value,[]);
        PageControlCadastro.ActivePage:= TabSheetFicha;
end;

procedure TF_CaixaMovimento.GridListaDrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
   GridZebrado (TDBGrid(Sender).DataSource.DataSet.RecNo, TDBGrid(Sender), Rect, Column, State); // Procedure para Pintar
end;

procedure TF_CaixaMovimento.GridListaKeyPress(Sender: TObject; var Key: Char);
begin
//ENTER No Lugar de TAB
    if key = #13 then
...
procedure TF_CaixaMovimento.GridZebrado(RecNo: Integer; Grid: TDBGrid; Rect: TRect;
...
procedure TF_CaixaMovimento.HabBotoesPesDesCheck;
begin
...
procedure TF_CaixaMovimento.HabCheckDesBotoes;
begin
...
procedure TF_CaixaMovimento.Inativo1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_CaixaMovimento.OrdeCodigoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_CaixaMovimento.OrdeDTAlteracaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_CaixaMovimento.OrdeDTHabilitacaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_CaixaMovimento.OrdeDTInclusaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_CaixaMovimento.PesCodigoClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.PesqPPAlteracaoClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.PesqPPInclusaoClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.PesqRegBloqueadosClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.PesqToRegClick(Sender: TObject);
begin
...
procedure TF_CaixaMovimento.PesquisaPorCodigo;
...
procedure TF_CaixaMovimento.PesquisaPorDescricao;
begin
  edtValorCampo.SetFocus;
...
procedure TF_CaixaMovimento.RGPesquisaGenericaClick(Sender: TObject);
begin
  edtValorCampo.SetFocus;
end;

procedure TF_CaixaMovimento.SetExecutar(const Value: TExecutar);
begin
...
procedure TF_CaixaMovimento.SomaTudo;
begin
  ADOCaixa_AbreFecha.Open;
  ADOCaixa_AbreFecha.Edit;
// Fazendo a soma das Entradas / Recebimentos
  ADOCaixa_AbreFecha.FieldByName('VLTOTALRECEBIDO').Value:= 0.00;

// Fazendo a soma das Saidas
  ADOCaixa_AbreFecha.FieldByName('VLTOTALSAIDA').Value:= (ADOCaixa_AbreFecha.FieldByName('VLSAIDACONTAS').Value);

// Fando as Contas De Valor Inicial mais Valor Recebido Menos a Saida
  ADOCaixa_AbreFecha.FieldByName('VLTOTALGERAL').Value:= ((ADOCaixa_AbreFecha.FieldByName('VLTOTALRECEBIDO').Value +
                                                          ADOCaixa_AbreFecha.FieldByName('VL_INICIO').Value)-
                                                          ADOCaixa_AbreFecha.FieldByName('VLTOTALSAIDA').Value);
// Colocando o Valor Total no Valor de Fechamento
  ADOCaixa_AbreFecha.FieldByName('VL_FECHAMENTO').Value:= ADOCaixa_AbreFecha.FieldByName('VLTOTALGERAL').Value;
  ADOCaixa_AbreFecha.Post;
end;

procedure TF_CaixaMovimento.Status1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
