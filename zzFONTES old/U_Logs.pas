...
// Verificando o que foi digitado para colocar na pesquisa
   if (F_PesqString.edtValor.Text = 'SAIDA') then
     ...
     if (F_PesqString.edtValor.Text = 'SAID') then
       begin
         F_PesqString.edtValor.Text:= 'S';
       end
     else
       if (F_PesqString.edtValor.Text = 'SAI') then
         begin
           F_PesqString.edtValor.Text:= 'S';
         end
       else
         if (F_PesqString.edtValor.Text = 'SA') then
           begin
             F_PesqString.edtValor.Text:= 'S';
           end
         else
           if (F_PesqString.edtValor.Text = 'S') then
             begin
               F_PesqString.edtValor.Text:= 'S';
             end
           else
             if (F_PesqString.edtValor.Text = 'AIDA') then
               begin
                 F_PesqString.edtValor.Text:= 'S';
               end
             else
                if (F_PesqString.edtValor.Text = 'IDA') then
                 begin
                   F_PesqString.edtValor.Text:= 'S';
                 end
               else
   ...
   if (F_PesqString.edtValor.Text = 'LOGOFF')  then
     ...
     if (F_PesqString.edtValor.Text = 'LOGOF')  then
       begin
          F_PesqString.edtValor.Text:= 'L';
       end
     else
       if (F_PesqString.edtValor.Text = 'LOGO')  then
         begin
            F_PesqString.edtValor.Text:= 'L';
         end
       else
         if (F_PesqString.edtValor.Text = 'LOG')  then
           begin
              F_PesqString.edtValor.Text:= 'L';
           end
         else
           if (F_PesqString.edtValor.Text = 'LO')  then
             begin
                F_PesqString.edtValor.Text:= 'L';
             end
           else
             if (F_PesqString.edtValor.Text = 'L')  then
               begin
                  F_PesqString.edtValor.Text:= 'L';
               end
             else
               if (F_PesqString.edtValor.Text = 'OGOFF')  then
                 begin
                    F_PesqString.edtValor.Text:= 'L';
                 end
               else
                 if (F_PesqString.edtValor.Text = 'GOFF')  then
                   begin
                      F_PesqString.edtValor.Text:= 'L';
                   end
                 else
                   if (F_PesqString.edtValor.Text = 'OFF')  then
                     begin
                        F_PesqString.edtValor.Text:= 'L';
                     end
                   else
                     if (F_PesqString.edtValor.Text = 'FF')  then
                       begin
                          F_PesqString.edtValor.Text:= 'L';
                       end
                     else
   ...
   if (F_PesqString.edtValor.Text = 'ENTRADA')  then
     ...
     if (F_PesqString.edtValor.Text = 'ENTRAD')  then
       begin
          F_PesqString.edtValor.Text:= 'E';
       end
     else
       if (F_PesqString.edtValor.Text = 'ENTRA')  then
         begin
            F_PesqString.edtValor.Text:= 'E';
         end
       else
         if (F_PesqString.edtValor.Text = 'ENTR')  then
           begin
              F_PesqString.edtValor.Text:= 'E';
           end
         else
           if (F_PesqString.edtValor.Text = 'EN')  then
             begin
                F_PesqString.edtValor.Text:= 'E';
             end
           else
            if (F_PesqString.edtValor.Text = 'E')  then
               begin
                  F_PesqString.edtValor.Text:= 'E';
               end
            else
             if (F_PesqString.edtValor.Text = 'NTRADA')  then
               begin
                  F_PesqString.edtValor.Text:= 'E';
               end
             else
              if (F_PesqString.edtValor.Text = 'TRADA')  then
                 begin
                    F_PesqString.edtValor.Text:= 'E';
                 end
              else
                if (F_PesqString.edtValor.Text = 'RADA')  then
                 begin
                    F_PesqString.edtValor.Text:= 'E';
                 end
                else
                  if (F_PesqString.edtValor.Text = 'ADA')  then
                   begin
                      F_PesqString.edtValor.Text:= 'E';
                   end;
