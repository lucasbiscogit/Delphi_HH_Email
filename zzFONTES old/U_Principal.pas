...
type
  TF_Principal = class(TForm)
    ...
    ADOQLoginFORNEC_MENU: TStringField;
    ADOQLoginFORNEC_INC: TStringField;
    ADOQLoginFORNEC_ALT: TStringField;
    ADOQLoginFORNEC_EXC: TStringField;
    ADOQLoginFORNEC_MAR: TStringField;
    ADOQLoginFORNEC_IMP: TStringField;
    ADOQLoginFORNEC_INA: TStringField;
    ADOQLoginFORNEC_HAB: TStringField;
    actFornecedor: TAction;
    CadastrodeFornecedor1: TMenuItem;
    Luz1: TMenuItem;
    Agua1: TMenuItem;
    ContadeLuzdoMes1: TMenuItem;
    LeituradasChacaras2: TMenuItem;
    GerarContas3: TMenuItem;
    N2: TMenuItem;
    N5: TMenuItem;
    N6: TMenuItem;
    ...
    procedure actFornecedorUpdate(Sender: TObject);
  private
...
procedure TF_Principal.actFornecedorExecute(Sender: TObject);
begin
  // Criar o From FORNECEDOR
  AbreForm(TF_Fornecedor, F_Fornecedor);
end;

procedure TF_Principal.actFornecedorUpdate(Sender: TObject);
begin
// Verificando a Permissao Pra Ver se pode Abrir Cadastro de fornecedor
   actFornecedor.Visible:= (ADOQLogin.FieldByName('FORNEC_MENU').AsAnsiString = 'S');
end;
...
begin
    ...
    if Application.MessageBox('          Deseja   Realmente   Fechar   a   Aplicação?          ',PChar('NoEmpresa'), MB_YESNO+MB_ICONQUESTION) = mrYes then
       begin
