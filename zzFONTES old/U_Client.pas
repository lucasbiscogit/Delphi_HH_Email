...
// Metodo Para Execuções
  ...
  TF_Cliente = class(TForm)
    ...
    mN4: TMenuItem;
    ADOQUsuariosDESC_EMPRESA: TStringField;
    Label2: TLabel;
    DBEdit2: TDBEdit;
...
procedure TF_Cliente.btnAlterarClick(Sender: TObject);
begin
...
procedure TF_Cliente.btnAnteriorClick(Sender: TObject);
begin
...
procedure TF_Cliente.btnFinalClick(Sender: TObject);
begin
...
procedure TF_Cliente.btnGravarClick(Sender: TObject);
var
...
procedure TF_Cliente.btnIncluirClick(Sender: TObject);
begin
...
procedure TF_Cliente.btnInicioClick(Sender: TObject);
begin
...
procedure TF_Cliente.btnOkClick(Sender: TObject);
begin
...
procedure TF_Cliente.btnProximoClick(Sender: TObject);
begin
...
procedure TF_Cliente.btnReverterClick(Sender: TObject);
begin
  // Verificando o que esta sendo Feito -- Adicionando  ou Editando Para Dar a mensagem
    if ADOTabela.State in [dsInsert] then               //*********** ADOQUERY = ADOTABELS **************************************
        begin
...
procedure TF_Cliente.btnSairClick(Sender: TObject);
begin
  Close; // Fechar a Tela
end;


procedure TF_Cliente.Descrio1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
...
procedure TF_Cliente.edtSenhaEnter(Sender: TObject);
begin
...
procedure TF_Cliente.edtSenhaExit(Sender: TObject);
var
...
procedure TF_Cliente.edtValorCampoKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TF_Cliente.ExcluirUMRegClick(Sender: TObject);
...
procedure TF_Cliente.edtLoginExit(Sender: TObject);
begin
...
procedure TF_Cliente.GridListaDblClick(Sender: TObject);
begin
        ADOTabela.Locate('ID',ADOQUsuariosID.Value,[]);
        PageControlCadastro.ActivePage:= TabSheetFicha;
end;

procedure TF_Cliente.GridListaDrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
   GridZebrado (TDBGrid(Sender).DataSource.DataSet.RecNo, TDBGrid(Sender), Rect, Column, State); // Procedure para Pintar
end;

procedure TF_Cliente.GridListaKeyPress(Sender: TObject; var Key: Char);
begin
//ENTER No Lugar de TAB
    if key = #13 then
...
procedure TF_Cliente.GridZebrado(RecNo: Integer; Grid: TDBGrid; Rect: TRect;
...
procedure TF_Cliente.HabBotoesPesDesCheck;
begin
...
procedure TF_Cliente.HabCheckDesBotoes;
begin
...
procedure TF_Cliente.Inativo1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Cliente.OrdeCodigoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Cliente.OrdeDTAlteracaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Cliente.OrdeDTHabilitacaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Cliente.OrdeDTInclusaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Cliente.PesCodigoClick(Sender: TObject);
begin
...
procedure TF_Cliente.PesqPPAlteracaoClick(Sender: TObject);
begin
...
procedure TF_Cliente.PesqPPInclusaoClick(Sender: TObject);
begin
...
procedure TF_Cliente.PesqRegBloqueadosClick(Sender: TObject);
begin
...
procedure TF_Cliente.PesqToRegClick(Sender: TObject);
begin
...
procedure TF_Cliente.PesquisaPorCodigo;
...
procedure TF_Cliente.PesquisaPorDescricao;
begin
  edtValorCampo.SetFocus;
...
procedure TF_Cliente.RGPesquisaGenericaClick(Sender: TObject);
begin
  edtValorCampo.SetFocus;
end;

procedure TF_Cliente.SetExecutar(const Value: TExecutar);
begin
...
procedure TF_Cliente.Status1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
