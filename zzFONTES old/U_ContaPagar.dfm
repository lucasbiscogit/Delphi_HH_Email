object F_ContaPagar: TF_ContaPagar
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object PageControlCadastro: TPageControl
    ...
    object TabSheetFicha: TTabSheet
      ...
      object pnlFichaCampos: TPanel
        ...
        object ComboFornec: TDBLookupComboBox
          Left = 252
          Top = 51
          Width = 501
          Height = 21
  ...
  object ADOQContaPagar: TADOQuery
    Connection = DMPrincipal.ADOConnectionPrincipal
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select * from TB_CONTAPAGAR'
      '')
    Left = 608
    Top = 48
    object ADOQContaPagarID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object ADOQContaPagarSTATUS: TStringField
      FieldName = 'STATUS'
      FixedChar = True
      Size = 1
    end
    object ADOQContaPagarINATIVO: TStringField
      FieldName = 'INATIVO'
      FixedChar = True
      Size = 1
    end
    object ADOQContaPagarDATA_INC: TDateTimeField
      FieldName = 'DATA_INC'
    end
    object ADOQContaPagarDATA_ALT: TDateTimeField
      FieldName = 'DATA_ALT'
    end
    object ADOQContaPagarDATA_HAB: TDateTimeField
      FieldName = 'DATA_HAB'
    end
    object ADOQContaPagarNUMDOC: TStringField
      FieldName = 'NUMDOC'
      Size = 200
    end
    object ADOQContaPagarID_CLIENTE: TIntegerField
      FieldName = 'ID_CLIENTE'
    end
    object ADOQContaPagarID_CLASSCONT: TIntegerField
      FieldName = 'ID_CLASSCONT'
    end
    object ADOQContaPagarNUMPARCELA: TStringField
      FieldName = 'NUMPARCELA'
      FixedChar = True
      Size = 3
    end
    object ADOQContaPagarTOTALPARCELA: TStringField
      FieldName = 'TOTALPARCELA'
      FixedChar = True
      Size = 3
    end
    object ADOQContaPagarVLTOTAL: TBCDField
      FieldName = 'VLTOTAL'
      DisplayFormat = '###,##0.00'
      Precision = 12
      Size = 2
    end
    object ADOQContaPagarVALORPARCELA: TBCDField
      FieldName = 'VALORPARCELA'
      DisplayFormat = '###,##0.00'
      Precision = 12
      Size = 2
    end
    object ADOQContaPagarLIQUIDADO: TStringField
      FieldName = 'LIQUIDADO'
      FixedChar = True
      Size = 1
    end
    object ADOQContaPagarDTPAGMENTO: TWideStringField
      FieldName = 'DTPAGMENTO'
      Size = 27
    end
    object ADOQContaPagarFORMA_PGTO: TStringField
      FieldName = 'FORMA_PGTO'
      Size = 50
    end
    object ADOQContaPagarVLPAGO: TBCDField
      FieldName = 'VLPAGO'
      DisplayFormat = 'R$ ###,##0.00'
      Precision = 12
      Size = 2
    end
    object ADOQContaPagarDATA_VENC: TDateTimeField
      FieldName = 'DATA_VENC'
      EditMask = '!99/99/0000;1;_'
    end
    object ADOQContaPagarOBS: TMemoField
      FieldName = 'OBS'
      BlobType = ftMemo
    end
  end
  object DSContaPagar: TDataSource
    DataSet = ADOQContaPagar
    Left = 704
    Top = 48
  end
  ...
  object ADOFornc: TADOQuery
    ...
    Left = 300
    Top = 174
    object ADOForncID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object ADOForncSTATUS: TStringField
      FieldName = 'STATUS'
      FixedChar = True
      Size = 1
    end
    object ADOForncINATIVO: TStringField
      FieldName = 'INATIVO'
      FixedChar = True
      Size = 1
    end
    object ADOForncDATA_INC: TDateTimeField
      FieldName = 'DATA_INC'
    end
    object ADOForncDATA_ALT: TDateTimeField
      FieldName = 'DATA_ALT'
    end
    object ADOForncDATA_HAB: TDateTimeField
      FieldName = 'DATA_HAB'
    end
    object ADOForncRAZAO_SOCIAL: TStringField
      FieldName = 'RAZAO_SOCIAL'
      Size = 100
    end
    object ADOForncNOME_FANTASIA: TStringField
      FieldName = 'NOME_FANTASIA'
      Size = 100
    end
    object ADOForncCNPJ: TStringField
      FieldName = 'CNPJ'
      Size = 18
    end
    object ADOForncIE: TStringField
      FieldName = 'IE'
      Size = 18
    end
    object ADOForncTELEF_COMERCIAL: TStringField
      FieldName = 'TELEF_COMERCIAL'
      Size = 13
    end
    object ADOForncATENDENTE: TStringField
      FieldName = 'ATENDENTE'
      Size = 100
    end
    object ADOForncSITE: TStringField
      FieldName = 'SITE'
      Size = 100
    end
  end
