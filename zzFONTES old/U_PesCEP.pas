...
begin
 btnSair.Tag:= 1; // colocando valor padrao para nao dar erro na tela de cadastro de chacara
  Close; // Fechar a Tela
end;
...
begin
 ...
 ENDERECO:= '';
 BAIRRO:= '';
 btnSair.Tag:= 0; // colocando valor padrao para nao dar erro na tela de cadastro de chacara
end;
