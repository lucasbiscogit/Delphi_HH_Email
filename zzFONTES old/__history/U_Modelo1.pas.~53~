...
procedure TF_Modelo1.btnAlterarClick(Sender: TObject);
begin
...
procedure TF_Modelo1.btnAnteriorClick(Sender: TObject);
begin
...
procedure TF_Modelo1.btnFinalClick(Sender: TObject);
begin
...
procedure TF_Modelo1.btnGravarClick(Sender: TObject);
var
...
procedure TF_Modelo1.btnIncluirClick(Sender: TObject);
begin
...
procedure TF_Modelo1.btnInicioClick(Sender: TObject);
begin
...
procedure TF_Modelo1.btnOkClick(Sender: TObject);
begin
...
procedure TF_Modelo1.btnProximoClick(Sender: TObject);
begin
...
procedure TF_Modelo1.btnReverterClick(Sender: TObject);
begin
  // Verificando o que esta sendo Feito -- Adicionando  ou Editando Para Dar a mensagem
    if ADOTabela.State in [dsInsert] then               //*********** ADOQUERY = ADOTABELS **************************************
        begin
...
procedure TF_Modelo1.btnSairClick(Sender: TObject);
begin
  Close; // Fechar a Tela
end;


procedure TF_Modelo1.Descrio1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
...
procedure TF_Modelo1.edtValorCampoKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TF_Modelo1.ExcluirUMRegClick(Sender: TObject);
...
procedure TF_Modelo1.FormActivate(Sender: TObject);
begin
...
procedure TF_Modelo1.GridListaDblClick(Sender: TObject);
begin
       // ADOTabela.Locate('ID',ADOTabelaID.Value,[]);
        PageControlCadastro.ActivePage:= TabSheetFicha;
end;

procedure TF_Modelo1.GridListaDrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
   GridZebrado (TDBGrid(Sender).DataSource.DataSet.RecNo, TDBGrid(Sender), Rect, Column, State); // Procedure para Pintar
end;

procedure TF_Modelo1.GridListaKeyPress(Sender: TObject; var Key: Char);
begin
//ENTER No Lugar de TAB
    if key = #13 then
...
procedure TF_Modelo1.GridZebrado(RecNo: Integer; Grid: TDBGrid; Rect: TRect;
...
procedure TF_Modelo1.HabBotoesPesDesCheck;
begin
...
procedure TF_Modelo1.HabCheckDesBotoes;
begin
...
procedure TF_Modelo1.Inativo1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Modelo1.OrdeCodigoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Modelo1.OrdeDTAlteracaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Modelo1.OrdeDTHabilitacaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Modelo1.OrdeDTInclusaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Modelo1.PesCodigoClick(Sender: TObject);
begin
...
procedure TF_Modelo1.PesqPPAlteracaoClick(Sender: TObject);
begin
...
procedure TF_Modelo1.PesqPPInclusaoClick(Sender: TObject);
begin
...
procedure TF_Modelo1.PesqRegBloqueadosClick(Sender: TObject);
begin
...
procedure TF_Modelo1.PesqToRegClick(Sender: TObject);
begin
...
procedure TF_Modelo1.PesquisaPorCodigo;
...
procedure TF_Modelo1.PesquisaPorDescricao;
begin
  edtValorCampo.SetFocus;
...
procedure TF_Modelo1.RGPesquisaGenericaClick(Sender: TObject);
begin
  edtValorCampo.SetFocus;
end;

procedure TF_Modelo1.SetExecutar(const Value: TExecutar);
begin
...
procedure TF_Modelo1.Status1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
