...
// Metodo Para Execuções
  ...
  TF_Fornecedor = class(TForm)
    ...
    mN4: TMenuItem;
    ADOFornecedorID: TAutoIncField;
    ADOFornecedorSTATUS: TStringField;
    ADOFornecedorINATIVO: TStringField;
    ADOFornecedorDATA_INC: TDateTimeField;
    ADOFornecedorDATA_ALT: TDateTimeField;
    ADOFornecedorDATA_HAB: TDateTimeField;
    ADOFornecedorRAZAO_SOCIAL: TStringField;
    ADOFornecedorNOME_FANTASIA: TStringField;
    ADOFornecedorCNPJ: TStringField;
    ADOFornecedorIE: TStringField;
    ADOFornecedorTELEF_COMERCIAL: TStringField;
    ADOFornecedorATENDENTE: TStringField;
    ADOFornecedorSITE: TStringField;
    Label1: TLabel;
    edtCodigo: TDBEdit;
    Label2: TLabel;
    edtRSocial: TDBEdit;
    ...
    procedure edtNFantasiaEnter(Sender: TObject);
    ...
    procedure edtTelComerEnter(Sender: TObject);
    procedure edtTelComerExit(Sender: TObject);
    ...
    procedure edtTelComerKeyPress(Sender: TObject; var Key: Char);
  private
...
procedure TF_Fornecedor.btnAlterarClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.btnAnteriorClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.btnFinalClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.btnGravarClick(Sender: TObject);
var
...
procedure TF_Fornecedor.btnIncluirClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.btnInicioClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.btnOkClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.btnProximoClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.btnReverterClick(Sender: TObject);
begin
  // Verificando o que esta sendo Feito -- Adicionando  ou Editando Para Dar a mensagem
    if ADOTabela.State in [dsInsert] then               //*********** ADOQUERY = ADOTABELS **************************************
        begin
...
procedure TF_Fornecedor.btnSairClick(Sender: TObject);
begin
  Close; // Fechar a Tela
end;

procedure TF_Fornecedor.Descrio1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
...
procedure TF_Fornecedor.edtAtendenteEnter(Sender: TObject);
begin
  edtAtendente.Color:=  clMoneyGreen;
end;

procedure TF_Fornecedor.edtAtendenteExit(Sender: TObject);
begin
  edtAtendente.Color:=  clWindow;
end;

procedure TF_Fornecedor.edtCNPJEnter(Sender: TObject);
begin
  edtCNPJ.Color:= clMoneyGreen;
end;

procedure TF_Fornecedor.edtCNPJExit(Sender: TObject);
begin
  edtCNPJ.Color:= clWindow;
end;

procedure TF_Fornecedor.edtCNPJKeyPress(Sender: TObject; var Key: Char);
begin
if not(key in ['0'..'9','.',',',#8,#13]) then   // Nao deixa Digitar Letras
   key := #0;
...
procedure TF_Fornecedor.edtIEEnter(Sender: TObject);
begin
  edtIE.Color:= clMoneyGreen;
end;

procedure TF_Fornecedor.edtIEExit(Sender: TObject);
begin
    edtIE.Color:= clWindow;
end;

procedure TF_Fornecedor.edtIEKeyPress(Sender: TObject; var Key: Char);
begin
if not(key in ['0'..'9','.',',',#8,#13]) then   // Nao deixa Digitar Letras
   key := #0;
   ...
   if Key = #8 then
      exit;
   if Length(edtIE.Text) = 3 then
      begin
         edtIE.Text := edtIE.Text + '.';
         edtIE.Selstart := Length(edtIE.text);
      end;
   if Length(edtIE.Text) = 7 then
      begin
         edtIE.Text := edtIE.Text + '.';
         edtIE.Selstart := Length(edtIE.text);
      end;
   if Length(edtIE.Text) = 11 then
      begin
         edtIE.Text := edtIE.Text + '.';
         edtIE.Selstart := Length(edtIE.text);
      end;
...
procedure TF_Fornecedor.edtNFantasiaEnter(Sender: TObject);
begin
  edtNFantasia.Color:= clMoneyGreen;
end;

procedure TF_Fornecedor.edtNFantasiaExit(Sender: TObject);
begin
  edtNFantasia.Color:= clWindow;
end;

procedure TF_Fornecedor.edtRSocialEnter(Sender: TObject);
begin
  edtRSocial.Color:= clMoneyGreen;
end;

procedure TF_Fornecedor.edtRSocialExit(Sender: TObject);
begin
  edtRSocial.Color:= clWindow;
end;

procedure TF_Fornecedor.edtTelComerEnter(Sender: TObject);
begin
  edtTelComer.Color:= clMoneyGreen;
end;

procedure TF_Fornecedor.edtTelComerExit(Sender: TObject);
begin
  edtTelComer.Color:= clWindow;
end;

procedure TF_Fornecedor.edtTelComerKeyPress(Sender: TObject; var Key: Char);
begin
if not(key in ['0'..'9','.',',',#8,#13]) then   // Nao deixa Digitar Letras
   key := #0;
   ...
   if Key = #8 then
      exit;
   if Length(edtTelComer.Text) = 0 then
      begin
         edtTelComer.Text := edtTelComer.Text + '(';
         edtTelComer.Selstart := Length(edtTelComer.text);
      end;
   if Length(edtTelComer.Text) = 3 then
      begin
         edtTelComer.Text := edtTelComer.Text + ')';
         edtTelComer.Selstart := Length(edtTelComer.text);
      end;
   if Length(edtTelComer.Text) = 8 then
      begin
         edtTelComer.Text := edtTelComer.Text + '-';
         edtTelComer.Selstart := Length(edtTelComer.text);
      end;
...
procedure TF_Fornecedor.edtValorCampoKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TF_Fornecedor.ExcluirUMRegClick(Sender: TObject);
...
procedure TF_Fornecedor.FormActivate(Sender: TObject);
begin
  ADOTabela:= ADOFornecedor;   // Definindo o Valor da Variavel que ira Receber o ADOQuery   //*********** ADOQUERY = ADOTABELS ******************
  nomeTabela:= 'TB_FORNECEDOR'; // Definindo a Tabela para trabalhar
  nomeJanela:= 'Cadastro de Fornecedor';  // Nome que ira aparecer
  GridLista.DataSource:= DSFornecedor;    //Colocando o Data Source no Grid
  DescPrincipal:= 'NOME_FANTASIA';  // Define o Campo que ira Fazer a Pesquisa Padrao por Desc.

    ModoEdicao:= F_Principal.ADOQLogin.FieldByName('FORNEC_INC').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('FORNEC_ALT').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('FORNEC_EXC').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('FORNEC_MAR').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('FORNEC_IMP').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('FORNEC_INA').AsAnsiString +
                 F_Principal.ADOQLogin.FieldByName('FORNEC_HAB').AsAnsiString;

// Caption dos ApplicationMessageBox  Do EXECUTAR SentencaSQL
    MensageAppMesBox:= 'CADASTRO DE FORNECEDORES';
...
procedure TF_Fornecedor.GridListaDblClick(Sender: TObject);
begin
        ADOTabela.Locate('ID',ADOFornecedorID.Value,[]);
        PageControlCadastro.ActivePage:= TabSheetFicha;
end;

procedure TF_Fornecedor.GridListaDrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
   GridZebrado (TDBGrid(Sender).DataSource.DataSet.RecNo, TDBGrid(Sender), Rect, Column, State); // Procedure para Pintar
end;

procedure TF_Fornecedor.GridListaKeyPress(Sender: TObject; var Key: Char);
begin
//ENTER No Lugar de TAB
    if key = #13 then
...
procedure TF_Fornecedor.GridZebrado(RecNo: Integer; Grid: TDBGrid; Rect: TRect;
...
procedure TF_Fornecedor.HabBotoesPesDesCheck;
begin
...
procedure TF_Fornecedor.HabCheckDesBotoes;
begin
...
procedure TF_Fornecedor.Inativo1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Fornecedor.OrdeCodigoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Fornecedor.OrdeDTAlteracaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Fornecedor.OrdeDTHabilitacaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Fornecedor.OrdeDTInclusaoClick(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
...
procedure TF_Fornecedor.PesCodigoClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.PesqPPAlteracaoClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.PesqPPInclusaoClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.PesqRegBloqueadosClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.PesqToRegClick(Sender: TObject);
begin
...
procedure TF_Fornecedor.PesquisaPorCodigo;
...
procedure TF_Fornecedor.PesquisaPorDescricao;
begin
  edtValorCampo.SetFocus;
...
procedure TF_Fornecedor.RGPesquisaGenericaClick(Sender: TObject);
begin
  edtValorCampo.SetFocus;
end;

procedure TF_Fornecedor.SetExecutar(const Value: TExecutar);
begin
...
procedure TF_Fornecedor.Status1Click(Sender: TObject);
begin
   ADOTabela.Close;
   ADOTabela.SQL.Clear;
   ADOTabela.SQL.Add (strSql);
