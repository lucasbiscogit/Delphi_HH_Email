...
begin
{$REGION 'VERIFICANDO O ESTA SENDO FEITO - INSERÇAO'}
    ...
    if ADOTabela.State in [dsInsert] then          //*********** ADOQUERY = ADOTABELS **************************************
       begin
          ...
          // Inserindo os dados no banco
            ...
            while not CDSetContaGerada.Eof do  // Faça enquanto não for o final do Registro
              begin
...
// ShowMessage(MesAnoSelecionado);
 ...
 if (ADOLeituraChaca.RecordCount = 0) then
  begin
      mensagem:= 'Nao Existe Contas Para Vincular com o Mes Selecionado, '+ MesAnoSelecionado + #13    // #13 Pular Linha   ' INFORMAÇÂO '
