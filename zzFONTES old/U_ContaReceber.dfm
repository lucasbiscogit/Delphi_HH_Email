object F_ContaReceber: TF_ContaReceber
  Left = 0
  Top = 0
  BorderIcons = []
    ...
    object TabSheetFicha: TTabSheet
      ...
      object pnlFichaCampos: TPanel
        ...
        object Label3: TLabel
          ...
          Height = 13
          Caption = 'Cliente'
          FocusControl = edtNumDoc
        end
        object lblDtVenc: TLabel
          Left = 14
          Top = 80
          Width = 81
          Height = 13
          Caption = 'Data Vencimento'
          FocusControl = edtDTVenc
        end
        object Label5: TLabel
          ...
          Width = 76
          Height = 13
          Caption = 'Numero da Parc'
          FocusControl = edtNumParcela
        end
        object Label6: TLabel
          ...
          FocusControl = edtTotParcela
        end
        object lblVlParcela: TLabel
          Left = 322
          Top = 80
          Width = 62
          Height = 13
          Caption = 'Valor Parcela'
          FocusControl = edtValorParcela
        end
        ...
        object edtDTVenc: TDBEdit
          ...
          DataSource = DSContaReceber
          TabOrder = 2
          OnEnter = edtDTVencEnter
          OnExit = edtDTVencExit
        end
        object edtNumParcela: TDBEdit
          Left = 125
          Top = 99
          Width = 43
          Height = 21
          ...
          DataSource = DSContaReceber
          TabOrder = 3
          OnEnter = edtNumParcelaEnter
          OnExit = edtNumParcelaExit
          OnKeyPress = edtNumParcelaKeyPress
        end
        object edtTotParcela: TDBEdit
          Left = 224
          Top = 99
          Width = 43
          Height = 21
          ...
          DataSource = DSContaReceber
          TabOrder = 4
          OnEnter = edtTotParcelaEnter
          OnExit = edtTotParcelaExit
          OnKeyPress = edtTotParcelaKeyPress
        end
        object edtValorParcela: TDBEdit
          Left = 322
          Top = 99
          Width = 83
          Height = 21
          ...
          DataSource = DSContaReceber
          TabOrder = 5
          OnEnter = edtValorParcelaEnter
          OnExit = edtValorParcelaExit
        end
        object RichOBS: TDBRichEdit
          Left = 14
          Top = 147
          Width = 739
          Height = 63
          ...
          TabOrder = 8
          Zoom = 100
          OnEnter = RichOBSEnter
          OnExit = RichOBSExit
        end
        object grupBoxPGT: TGroupBox
          Left = 14
          Top = 229
          Width = 739
          Height = 81
          ...
          object Label14: TLabel
            ...
            FocusControl = edtFormPGT
          end
          object edtDTPGT: TDBEdit
            Left = 192
            Top = 37
            Width = 95
            Height = 24
            Color = clInfoBk
            DataField = 'DTPAGMENTO'
            DataSource = DSContaReceber
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -13
        ...
        object ComboContabil: TDBLookupComboBox
          Left = 509
          Top = 99
          Width = 244
          Height = 21
          DataField = 'ID_CLASSCONT'
          DataSource = DSContaReceber
          KeyField = 'ID'
          ListField = 'DESC_CLASSCONT'
          ListSource = DSClassCont
          TabOrder = 7
          OnEnter = ComboContabilEnter
          OnExit = ComboContabilExit
        end
        object edtNomeCha: TDBEdit
          Left = 476
          Top = 51
          Width = 204
          Height = 21
  ...
  object ADOQContaReceber: TADOQuery
    Connection = DMPrincipal.ADOConnectionPrincipal
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select * from TB_CONTARECEBER')
    Left = 632
    Top = 48
    object ADOQContaReceberID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object ADOQContaReceberSTATUS: TStringField
      FieldName = 'STATUS'
      FixedChar = True
      Size = 1
    end
    object ADOQContaReceberINATIVO: TStringField
      FieldName = 'INATIVO'
      FixedChar = True
      Size = 1
    end
    object ADOQContaReceberDATA_INC: TDateTimeField
      FieldName = 'DATA_INC'
    end
    object ADOQContaReceberDATA_ALT: TDateTimeField
      FieldName = 'DATA_ALT'
    end
    object ADOQContaReceberDATA_HAB: TDateTimeField
      FieldName = 'DATA_HAB'
    end
    object ADOQContaReceberNUMDOC: TStringField
      FieldName = 'NUMDOC'
      Size = 200
    end
    object ADOQContaReceberID_CLIENTE: TIntegerField
      FieldName = 'ID_CLIENTE'
    end
    object ADOQContaReceberID_CLASSCONT: TIntegerField
      FieldName = 'ID_CLASSCONT'
    end
    object ADOQContaReceberNUMPARCELA: TStringField
      FieldName = 'NUMPARCELA'
      FixedChar = True
      Size = 3
    end
    object ADOQContaReceberTOTALPARCELA: TStringField
      FieldName = 'TOTALPARCELA'
      FixedChar = True
      Size = 3
    end
    object ADOQContaReceberVLTOTAL: TBCDField
      FieldName = 'VLTOTAL'
      DisplayFormat = '###,##0.00'
      Precision = 12
      Size = 2
    end
    object ADOQContaReceberVALORPARCELA: TBCDField
      FieldName = 'VALORPARCELA'
      DisplayFormat = '###,##0.00'
      Precision = 12
      Size = 2
    end
    object ADOQContaReceberLIQUIDADO: TStringField
      FieldName = 'LIQUIDADO'
      FixedChar = True
      Size = 1
    end
    object ADOQContaReceberDTPAGMENTO: TWideStringField
      FieldName = 'DTPAGMENTO'
      Size = 27
    end
    object ADOQContaReceberFORMA_PGTO: TStringField
      FieldName = 'FORMA_PGTO'
      Size = 50
    end
    object ADOQContaReceberVLPAGO: TBCDField
      FieldName = 'VLPAGO'
      DisplayFormat = 'R$ ###,##0.00'
      Precision = 12
      Size = 2
    end
    object ADOQContaReceberDATA_VENC: TDateTimeField
      FieldName = 'DATA_VENC'
      EditMask = '!99/99/0000;1;_'
    end
    object ADOQContaReceberOBS: TMemoField
      FieldName = 'OBS'
      BlobType = ftMemo
    end
  end
  object DSContaReceber: TDataSource
    DataSet = ADOQContaReceber
    Left = 704
    Top = 48
  end
  ...
  object ADOClient: TADOQuery
    ...
    Left = 300
    Top = 174
    object ADOClientID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object ADOClientSTATUS: TStringField
      FieldName = 'STATUS'
      FixedChar = True
      Size = 1
    end
    object ADOClientINATIVO: TStringField
      FieldName = 'INATIVO'
      FixedChar = True
      Size = 1
    end
    object ADOClientDATA_INC: TDateTimeField
      FieldName = 'DATA_INC'
    end
    object ADOClientDATA_ALT: TDateTimeField
      FieldName = 'DATA_ALT'
    end
    object ADOClientDATA_HAB: TDateTimeField
      FieldName = 'DATA_HAB'
    end
    object ADOClientNOME_CHACARA: TStringField
      FieldName = 'NOME_CHACARA'
      Size = 100
    end
    object ADOClientNOME_PROPRIETARIO: TStringField
      FieldName = 'NOME_PROPRIETARIO'
      Size = 100
    end
    object ADOClientNUMERO_CHACARA: TIntegerField
      FieldName = 'NUMERO_CHACARA'
    end
    object ADOClientLARGURA: TIntegerField
      FieldName = 'LARGURA'
    end
    object ADOClientCOMPRIMENTO: TIntegerField
      FieldName = 'COMPRIMENTO'
    end
    object ADOClientTELEFONE_PROP: TStringField
      FieldName = 'TELEFONE_PROP'
      Size = 13
    end
    object ADOClientCELULAR_PROP: TStringField
      FieldName = 'CELULAR_PROP'
      Size = 16
    end
    object ADOClientCEP_PROP: TStringField
      FieldName = 'CEP_PROP'
      Size = 18
    end
    object ADOClientENDERECO_PROP: TStringField
      FieldName = 'ENDERECO_PROP'
      Size = 50
    end
    object ADOClientNUMERO_RESID_PROP: TIntegerField
      FieldName = 'NUMERO_RESID_PROP'
    end
    object ADOClientBAIRRO_PROP: TStringField
      FieldName = 'BAIRRO_PROP'
      Size = 50
    end
    object ADOClientCOMPLEMENTO__PROP: TStringField
      FieldName = 'COMPLEMENTO__PROP'
    end
    object ADOClientCPF_PROP: TStringField
      FieldName = 'CPF_PROP'
      Size = 18
    end
    object ADOClientEMAIL_PROP: TStringField
      FieldName = 'EMAIL_PROP'
      Size = 50
    end
    object ADOClientUF: TStringField
      FieldName = 'UF'
      FixedChar = True
      Size = 2
    end
    object ADOClientCIDADE_PROP: TStringField
      FieldName = 'CIDADE_PROP'
      Size = 50
    end
    object ADOClientNUMERO_RELOGIO: TIntegerField
      FieldName = 'NUMERO_RELOGIO'
    end
    object ADOClientLEITURA_INICIAL: TIntegerField
      FieldName = 'LEITURA_INICIAL'
    end
    object ADOClientTXRUA: TStringField
      FieldName = 'TXRUA'
      FixedChar = True
      Size = 1
    end
    object ADOClientTXLEITURA: TStringField
      FieldName = 'TXLEITURA'
      FixedChar = True
      Size = 1
    end
    object ADOClientTXENERGIA: TStringField
      FieldName = 'TXENERGIA'
      FixedChar = True
      Size = 1
    end
  end
  object ADOClassContabil: TADOQuery
    Connection = DMPrincipal.ADOConnectionPrincipal
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
  ...
  object DSClassCont: TDataSource
    DataSet = ADOClassContabil
    Left = 636
    Top = 222
  end
end
