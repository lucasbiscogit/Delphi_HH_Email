...
// Controle do Botao Pesquisar da Janela Pesquiar por datas
 ...
 {VARIAVEIS PARA DEIXAR COMO GENERICA A TELA}
  ...
  RelatorioPerfil: Integer; // Variavel para Verificar qual relatorio tera que executar (Todos e Um Só)
...
// Verificando se o Campo Login esta Vazio
  if Trim(edtDescricao.Text) = '' then
     begin
       Beep;
       ShowMessage('O Campo DESCRICAO DE PERFIL, não pode Ficar Vazio.');
